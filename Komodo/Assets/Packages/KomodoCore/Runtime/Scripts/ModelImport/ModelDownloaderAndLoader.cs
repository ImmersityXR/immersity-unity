...
namespace Komodo.AssetImport
{
    public class ModelDownloaderAndLoader : MonoBehaviour
    {
        ...
        */
        public IEnumerator GetFileFromURL(ModelImportData modelData, Text progressDisplay, int index, System.Action<ModelFile> callback)
        {
        ...
        */
        private IEnumerator DownloadFile(ModelImportData modelData, Text progressDisplay, int index, string localPathAndFilename, System.Action<ModelFile> callback = null)
        {
